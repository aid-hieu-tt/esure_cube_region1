...
export const MainTables: React.FC<MainTablesProps> = ({ regions, highlightedRegion }) => {
  ...
  return (
    <div className="overflow-hidden rounded-md bg-white shadow-sm" id="main-table">
      <h3 className="border-b border-gray-200 p-4 text-lg font-semibold text-gray-800">Top 10 TLHT</h3>
      <div className="overflow-x-auto">
        <table className="border-collapse w-full text-left">
          <thead>
            <tr className="bg-[#0a2342] text-white">
              <th
                className="cursor-pointer p-3 transition-colors hover:bg-blue-900"
                onClick={() => {
              ...
              <th
                className="cursor-pointer p-3 transition-colors hover:bg-blue-900"
                onClick={() => {
                  return handleSort('businessUnit');
                }}
              >
                Sản phẩm <SortIcon field="businessUnit" />
              </th>
              <th
                className="cursor-pointer p-3 text-right transition-colors hover:bg-blue-900"
                onClick={() => {
                  return handleSort('salesNT');
                }}
              >
              ...
              <th
                className="cursor-pointer p-3 text-right transition-colors hover:bg-blue-900"
                onClick={() => {
                  return handleSort('completionRate');
                }}
              >
